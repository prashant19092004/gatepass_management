...
const Userprofile = () => {
  ...
  async function fetchingHistory(){
    try{
      await axios.get("http://localhost:9000/student/userhistory", {
        headers: {
      ...
      .then((res) => {
        ...
        setUser(res.data);
        setUserHistory(res.data.requests);
      })
    }catch(err){
      console.log(err);
    }
  ...
  return (
    <div class="p-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div>
                        <p class="font-bold text-gray-700 text-xl">{userHistory?.length}</p>
                        <p class="text-gray-400">Requests</p>
                    </div>
                    {/* <div>
                        <p class="font-bold text-gray-700 text-xl">{userHistory?.length}</p>
                        <p class="text-gray-400">Accepted</p>
                    </div>
                        <div>
                ...
                <div class="mt-20 text-center border-b pb-12">
                    ...
                    <p class="font-light text-gray-600 mt-3">{user?.admission_no}</p>

                    <p class="mt-8 text-gray-500">Swami Vivekanand Group of Institutes,</p>
                    <p class="mt-2 text-gray-500">Banur</p>
                </div>
